...
from coco_tasks.joint_classifier_experiments import JointClassifierExperimentWithClass
from coco_tasks.joint_classifier_networks import JointClassifierWithClass
...
def main(random_seed, test_on_gt, only_test, overfit):
    ...
    train_folder = "ablation-joint-classifier-withclass-seed:{s}".format(s=random_seed)
